...
class SingleRuleParser:
    ...
    OPTIONS_SPLIT_RE = re2.compile(OPTIONS_SPLIT_PAT, max_mem=2048*1024*1024 - 1)
    ...
    def _url_matches(self, url):
        if self.regex_re is None:
            self.regex_re = re2.compile(self.regex, max_mem=2048*1024*1024 - 1)
