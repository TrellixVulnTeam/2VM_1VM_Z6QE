...
class BlockListParser:
    ...
    def __init__(self, regex_file=None, regexes=None, shortcut_sizes=None,print_maps=False, support_hash=False, name=None):
    ...
    def _get_all_shortcut_url_maps(self, lines):
        all_shortcut_url_maps = []
        for shortcut_size in self.shortcut_sizes:
            pat = re2.compile(r'[\w\/\=\.\-\?\;\,\&]{%d,}' % shortcut_size, max_mem=self.max_mem)
